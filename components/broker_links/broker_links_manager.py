#!/usr/bin/env python3
"""
Componente per gestione Link Broker
...
class BrokerLinksManager:
    ...
    def render_stats(self):
        ...
        try:
            stats = self.db.get_broker_links_stats()
    ...
    def render_broker_link_form(self):
        ...
        if st.session_state.broker_links_editing:
            editing_link = self.db.get_broker_link(st.session_state.broker_links_editing)
    ...
    def delete_broker_link(self, link_id: int) -> bool:
        ...
        try:
            return self.db.delete_broker_link(link_id)
        except Exception as e:
    ...
    def toggle_broker_link_status(self, link_id: int) -> bool:
        ...
        try:
            return self.db.toggle_broker_link_status(link_id)
        except Exception as e:
