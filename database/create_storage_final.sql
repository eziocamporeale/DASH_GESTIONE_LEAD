-- Tabella per la gestione dei file storage - VERSIONE FINALE CORRETTA
...
-- Policy: tutti possono inserire i propri download (CORRETTO: usa auth.uid()::integer)
...
-- Policy: utenti possono vedere solo i propri download (CORRETTO: usa auth.uid()::integer)
